...
//调整Combobox，以支持搜索时中文输入结束不自动触发查询 将触发查询执行的引起事件由keydown改成 keyup
...
var opts=$(this).combobox("options");
//1、调整Combobox支持模糊查询，并支持从任意位置开始匹配 return row[opts.textField].toLowerCase().indexOf(q.toLowerCase())>=0;
